...
// pre, working na daw ba gantt
        processes.add(new Process(1,10,9,1));
        processes.add(new Process(2,85,14,1));
        processes.add(new Process(3,0,12,1));
        processes.add(new Process(4,89,10,1)); // missing process?
        processes.add(new Process(5,101,7,1));
        processes.add(new Process(6,15,15,1));
        processes.add(new Process(7,95,3,1));
        processes.add(new Process(8,5,3,1));
